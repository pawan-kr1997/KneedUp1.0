        ...
        <Navbar bg="dark" variant="dark" expand={false}>
            <Container fluid>
                <Navbar.Brand className='LogoFont'>
                    ...
                    <div style={{ color: "#B60000" }}>.</div></Navbar.Brand>
                ...
                >
                    ...
                    <Offcanvas.Body>
                        ...
                        <ListGroup.Item action className='OffcanvasList' onClick={()=>{aboutHandler();handleClose()}}>
                            <MdOutlinePeopleAlt />
                            About Us
                        </ListGroup.Item>
                        <ListGroup.Item action className='OffcanvasList' onClick={()=>{bookmarkHandler();handleClose()}}>
                            <BiBookmarks />
                            Bookmarks
                        </ListGroup.Item>
                        
                        {props.showFollowSite?<ListGroup.Item action className='OffcanvasList' onClick={()=>{props.showHandler(); handleClose()}}>
                            <BiStar />
                            Follow Sites
                        </ListGroup.Item>: null}
